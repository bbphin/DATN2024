...
Route::middleware('checkauth')->prefix('account')->name('account.')->group(function () {
    Route::get('getinfo', [ClientAccountController::class, 'index'])->name('getInfo');
    ...
    Route::post('changepassword', [ClientAccountController::class, 'changePassword'])->name('postChangePassword');
});
